...
<img src="./docs/screenshots/MainOmniRoute.png" alt="Golden Router Dashboard" width="820"/>

<br/>

# 🚀 Golden Router — All In One Best Number 1 Router System
...
[![Cloud Sync](https://img.shields.io/badge/Cloud_Sync-Supabase-3ECF8E?style=for-the-badge)](#-cloud-sync)
[![$0 to start](https://img.shields.io/badge/%240-To_Start-FDCB6E?style=for-the-badge&logoColor=black)](#-quick-start)

[![npm](https://img.shields.io/npm/v/golden-router?logo=npm&style=flat-square)](https://www.npmjs.com/package/golden-router)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)
[![Node](https://img.shields.io/badge/node-%E2%89%A522.22.2-brightgreen?style=flat-square)](package.json)
[![Stars](https://img.shields.io/github/stars/dwi/golden-router?style=social)](https://github.com/dwi/golden-router)

<div align="center">

[![npm version](https://img.shields.io/npm/v/golden-router?color=cb3837&logo=npm)](https://www.npmjs.com/package/golden-router)
![NPM Monthly](https://img.shields.io/npm/dm/golden-router?label=npm/month&color=cb3837&logo=npm)
[![Docker Hub](https://img.shields.io/docker/v/dwi/golden-router?label=Docker%20Hub&logo=docker&color=2496ED)](https://hub.docker.com/r/dwi/golden-router)
![Docker Pulls](https://img.shields.io/docker/pulls/dwi/golden-router?label=docker%20pulls&logo=docker&color=2496ED)
![Electron Downloads](https://img.shields.io/github/downloads/dwi/golden-router/total?style=flat&label=electron%20downloads&logo=electron&color=47848F)
[![Website](https://img.shields.io/badge/Website-github.com-blue?logo=github&logoColor=white)](https://github.com/dwi/golden-router)

</div>

<br/>

[**🚀 Quick Start**](#-quick-start) • [**🎯 Combos**](#-combos--the-flagship) • [**🌐 Providers**](#-177-ai-providers--50-free) • [**🔌 CLI & MCP**](#-full-cli--a2a--mcp) • [**🗜️ Compression**](#%EF%B8%8F-save-1595-tokens--automatically) • [**☁️ Cloud Sync**](#-cloud-sync) • [**� Support**](#-support--community)

[💥 The Promise](#-the-promise) • [🤔 Why](#-why-golden-router) • [🏆 What Sets Apart]((#-what-sets-golden-router-apart) • [🤖 Compatible CLIs](#-compatible-clis--coding-agents) • [🖥️ Where It Runs]((#%EF%B8%8F-where-golden-router-runs--anywhere) • [🔒 Private](#-private--local-first) • [🎬 In Action](#-golden-router-in-action) • [📚 Explore More](#-explore-more)
